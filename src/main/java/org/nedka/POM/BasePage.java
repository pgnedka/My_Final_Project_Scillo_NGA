...
public abstract class BasePage {
    ...
    public void clickOn(WebElement element) {
     ...
     public void provideText(WebElement element, String providedText){
        wait.until(ExpectedConditions.visibilityOf(element));  //проверяваме дали даден елемент е показан
        element.clear();
        element.sendKeys(providedText);
        log.info("The user has provided " + providedText + " in " + element);
     }
